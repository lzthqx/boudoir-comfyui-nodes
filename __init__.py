...
NODE_DISPLAY_NAME_MAPPINGS = {
    "BoudoirPromptSearch": "Search Prompt Library",
    "BoudoirRandomPrompt": "Random Prompt",
    "BoudoirPromptById": "Get Prompt by ID",
    "BoudoirPromptCategories": "List Categories",
    "BoudoirPromptSearchWidget": "Search & Select Prompt",
    "LoRATriggerWordExtractor": "LoRA Trigger Word (Path)",
    "LoRATriggerWordFromLoader": "LoRA Trigger Word (Dropdown)",
    "LoRALoaderWithTrigger": "Load LoRA + Trigger (Model)",
    "LoRALoaderModelClipWithTrigger": "Load LoRA + Trigger (Model+CLIP)",
    "MultiLoRALoaderWithTriggers": "Multi-LoRA Loader (5x) + Triggers",
    "PowerLoRALoaderWithTriggers": "Power LoRA Loader + Triggers",
    "LoRAFolderLoaderWithTrigger": "Load LoRA (Folder) + Trigger (Model)",
    "LoRAFolderLoaderModelClipWithTrigger": "Load LoRA (Folder) + Trigger (Model+CLIP)",
    "ZImageResolutionSelector": "Z-Image Resolution Selector",
}
